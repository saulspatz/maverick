            ...
            RankSet diamonds, RankSet clubs)
{
    ...
    int cards[15][5]; // no rank 0; row and column totals
    ...
    // Now find the straights.  First, reuse the suit count
    // to hold the high Ace, if there is an Ace in the suit
