...
void dist_11_11_2_1() {
  ...
  RankSet *DIAMONDS_START = ranks2;
  RankSet *DIAMONDS_END = DIAMONDS_START + 41;
  RankSet *SYM_START = DIAMONDS_START + 36;
  ...
  sprintf(buffer,"%-9s, %lu, %lu, %lu, %lu, %lu, %lu, %lu, %.2f\n",
       "11-11-2-1", exhaustC, heurC, skipC, exhaustD, heurD, skipD, solutions, time);
  fputs(buffer, out);
  fclose(out);
}