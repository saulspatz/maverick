...
const long max_nodes=1000000;       /* at most this many nonzero elements in the matrix */
int verbose;                  /* kludge because of 64-bit madness in SGB library */
const long buf_size = 8*max_cols + 3;
...
and each row is represented as a linked list of node structs. There is one
...
root = col_array[0] /* gateway to the unsettled columns */
